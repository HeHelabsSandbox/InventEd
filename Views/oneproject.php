...
if ($_SESSION['check'] == "loggedIn") {
    if ($_SESSION['response'] == 1) {
      ...
      <form action="assets/script.php" method="POST">
        ...
        <button type="submit" name="joinProject" class="btn btn-opaque" id="joinProject"> Join Project</button>
      </form>
      '; 
    }
} else {
echo '
  <a href="login.php?who=signin&no='.$id.'" class="btn btn-opaque" id="joinProject"> Join Project</a>
';
  }
 ?>
 <br>
